...
def validateUsername(n_clicks, usernameSubmit, newPassword1Submit,
    ...
    if (n_clicks > 0) or (usernameSubmit > 0) or (newPassword1Submit > 0) or \
        ...
        if newUsername == None or newUsername == '' or User.query.filter_by(username=newUsername).first():
...
def validatePassword1(n_clicks, usernameSubmit, newPassword1Submit,
    ...
    if (n_clicks > 0) or (usernameSubmit > 0) or (newPassword1Submit > 0) or \
        ...
        if newPassword1 == newPassword2 and len(newPassword1) > 3:
            return 'form-control is-valid'
        else:
            return 'form-control is-invalid'
    else:
        ...
        if newUser and newPassword1 and newPassword2 and newEmail != '':
            if newPassword1 == newPassword2:
                if len(newPassword1) > 3:
                    try:
                        add_user(newUser, newPassword1, newEmail, bool(admin))
                    ...
                    return html.Div(children=['New Password Must Be Minimum 4 Characters'], className='text-danger')
            else:
