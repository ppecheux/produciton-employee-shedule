...
layout = html.Div(
    className='pageContent2', children=[
        html.H1("Tutorial Page"),
        html.Div(className='tutorialTitle', children=[
            "ESTAÇÕES"]),
        html.Div(className='tutorialText', children=[
        ...
        html.Br(),
        html.A("Video ESTAÇÕES",
               href='https://www.youtube.com/watch?v=TT8KuCXRKJ8', target="_blank"),
